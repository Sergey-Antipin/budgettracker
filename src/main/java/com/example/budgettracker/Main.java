...
public class Main {
    public static User USER = new User(1,"antipin@mail.ru", new Date(), new ArrayList<>(), new HashMap<>(), new HashSet<>());
    ...
    static {
        ...
        USER.getExpenseLimits().put(ExpenseCategory.CAR, Money.parse("RUB -3000"));
        ...
        USERDTO = UserMapper.createDto(USER);
    }
